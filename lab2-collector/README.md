...
The timer publishes every five minutes. Combined with the Worker's single KV
write per report, this uses about 288 KV writes per day and remains inside the
six-minute `fresh` window.
